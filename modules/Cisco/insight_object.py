...
from modules.init_packages import numpy as np
from modules.init_packages import requests
from modules.init_packages import json
...
class NetworkInsightCreateUpdate:
    ...
    def update_or_create_insight(self, data):
        ...
        for data in data_list:
            ...
            if flag:
                print(f"Data is creating for {data_hostname}")
